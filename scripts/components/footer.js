    ...
    view: (model) => {
        ...
        return R.footer({ classes: "footer" }, [
                    ...
                    R.ul({ classes: "filters" }, [
                        R.li(null, R.a({ href: '#', classes: allClass, onClick: model.onFilterSelected.bind(null, "all") }, "All")),
                        R.li(null, R.a({ href: '#', classes: activeClass, onClick: model.onFilterSelected.bind(null, "active") }, "Active")),
                        R.li(null, R.a({ href: '#', classes: completedClass, onClick: model.onFilterSelected.bind(null, "completed") }, "Completed"))
                    ])
        ]);
    }
});
